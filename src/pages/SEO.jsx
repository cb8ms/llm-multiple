  ...
  return (
    <div className="p-8 max-w-xl mx-auto">
      ...
      <div className="text-sm">
        <p>First select the type of input, if selecting CSV for Bulk upload, please download <a href="https://docs.google.com/spreadsheets/d/1jt1pljedbNNdzBHes-lONTYTTdZvDSrHdhjWatfP6CE/edit?gid=0#gid=0">THIS TEMPLATE</a> </p>
        <p>Click on File, Download and than select Comma-separated values (.csv) </p>
      <p>Please note that currently the maximum that can be uploaded at once is 70 lines on the CSV file. If it is more then 70, please use multiple sheets.</p></div>
      <div className="mb-4">
